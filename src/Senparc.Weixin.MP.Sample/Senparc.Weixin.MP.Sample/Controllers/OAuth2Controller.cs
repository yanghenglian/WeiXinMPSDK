    ...
    public class OAuth2Controller : Controller
    {
        ...
        public ActionResult Index(string returnUrl)
        {
            ...
            ViewData["UrlUserInfo"] =
                ...
                "http://1550z729q2.iask.in/oauth2/UserInfoCallback?returnUrl=" + returnUrl.UrlEncode(),
                state, OAuthScope.snsapi_userinfo);
            ViewData["UrlBase"] =
                OAuthApi.GetAuthorizeUrl(appId,
                "http://1550z729q2.iask.in/oauth2/BaseCallback?returnUrl=" + returnUrl.UrlEncode(),
